...
static size_t	get_ceil_square_root(size_t num)
{
	size_t	i;
...
static size_t	compare_distance_from_edge(size_t top, size_t bottom, size_t stack_size)
{
...
static size_t	get_nearest_value_idx(t_stack *stack, size_t stack_size, size_t max)
{
	size_t	top;
	size_t	bottom;
	t_stack	*ptr;
